...
let solve (day: int) (part: int) (input: string) : string option =
    ...
    | 13, 1 -> Some <| Day13.Part1.solve input
    | 13, 2 -> Some <| Day13.Part2.solve input
    | 14, 1 -> Some <| Day14.Part1.solve input
    | 14, 2 -> Some <| Day14.Part2.solve input
    | 15, 1 -> Some <| Day15.Part1.solve input
    | 15, 2 -> Some <| Day15.Part2.solve input
    | 16, 1 -> Some <| Day16.Part1.solve input
    | _ -> None
