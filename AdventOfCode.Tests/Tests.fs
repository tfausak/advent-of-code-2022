...
type TestClass() =
    ...
    [<TestMethod>]
    member this.TestDay13Part1() = test 13 1 "6187"

    [<TestMethod>]
    member this.TestDay13Part2() = test 13 2 "23520"

    [<TestMethod>]
    member this.TestDay14Part1() = test 14 1 "793"

    [<TestMethod>]
    member this.TestDay14Part2() = test 14 2 "24166"

    [<TestMethod>]
    member this.TestDay15Part1() = test 15 1 "4560025"
